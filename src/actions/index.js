...
export function fetchFixtures(competitionId, params) {
  return (dispatch) => {
    ...
    return api.fetch(`/competitions/${competitionId}/fixtures`, params)
    .then((response) => {
...
export function fetchStandings(competitionId, params) {
  return (dispatch) => {
    ...
    return api.fetch(`/competitions/${competitionId}/standings`, params)
    .then((response) => {
...
export function fetchCompetition(id, params) {
  return (dispatch) => {
    ...
    return api.fetch(`/competitions/${id}`, params)
    .then((response) => {
...
export function fetchCompetitions(params) {
  return (dispatch) => {
    ...
    return api.fetch('/competitions', params)
    .then((response) => {
...
export function fetchTeams(competitionId, params) {
  return (dispatch) => {
    ...
    return  api.fetch(`/competitions/${competitionId}/teams`, params)
    .then((response) => {
