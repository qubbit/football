...
export function normalizeColor(colorString = '0,0,0,0') {
  return colorString
    .split(',')
...
export function normalizeCompetition(competition) {
  return {
    ...competition,
    urlShort: competition.uri.split('/')[1],
    color: normalizeColor(competition.primaryColor)
  };
}

export function normalizeCompetitions(competitions) {
  return competitions
